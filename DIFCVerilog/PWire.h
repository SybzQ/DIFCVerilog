...
class Design;
class SecType;
// Legacy types kept for parser/pform compatibility; DIFCVerilog uses SecType.
class SecMaxType ;
class SecDownType;
...
class PWire : public LineInfo {
	...
	// Return a hierarchical name.
      ...
      bool set_max_type(SecMaxType *);
      bool set_down_type(SecDownType*);
    ...
    private:
      ...
      SecType* sectype_;
      // Legacy labels retained for front-end compatibility.
      SecMaxType * maxtype_;
      SecDownType* downtype_;
      ivl_variable_type_t data_type_;
      bool signed_;
      bool isint_;		// original type of integer
      // basenameMapping and counter for unique name generation
      mutable std::map<perm_string, int> basenameMapping; // mutable allows modification in const member functions
      mutable int counter; // mutable allows modification in const member functions
