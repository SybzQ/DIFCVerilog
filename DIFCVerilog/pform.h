...
extern void pform_startmodule(const char*, const char*file, unsigned lineno,
			      svector<named_pexpr_t*>*attr,SecType* sec, SecMaxType* tre, SecDownType* down);
extern void pform_module_set_ports(vector<Module::port_t*>*);

/* SecMaxType/SecDownType parameters are retained for legacy interfaces only. */
...
extern void pform_makewire(const struct vlltype&li, perm_string name,
			   ...
			   SecMaxType * mt= new SecMaxType (),
			   SecDownType * nt= new SecDownType ());
...
extern void pform_set_port_type(const struct vlltype&li,
	...
	SecMaxType * mt,
	SecDownType * nt);
extern void pform_set_port_type(perm_string nm, NetNet::PortType pt, SecType* st, SecMaxType * mt, SecDownType * nt,
				const char*file, unsigned lineno);
...
extern void pform_set_reg_integer_type(list<perm_string>*names, SecType*st, SecMaxType * mt,SecDownType * nt);
extern void pform_set_reg_time(list<perm_string>*names);
extern void pform_set_reg_time_type(list<perm_string>*names, SecType*st, SecMaxType * mt, SecDownType* nt);
...
extern void pform_set_parameter(const struct vlltype&loc,
				...
				bool signed_flag,
				svector<PExpr*>*range,
				PExpr*expr, LexicalScope::range_t*value_range,SecType* st);
extern void pform_set_localparam(const struct vlltype&loc,
				 perm_string name,
				 ivl_variable_type_t type,
				 bool signed_flag,
				 svector<PExpr*>*range,
				 PExpr*expr,SecType* st);
