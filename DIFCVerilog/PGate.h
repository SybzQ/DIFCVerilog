...
class PGAssign  : public PGate {
    ...
    public:
      ...
      virtual void elaborate(Design*des, NetScope*scope) const;
      virtual bool elaborate_sig(Design*des, NetScope*scope) const;
      int typecheck(ostream&out, TypeEnv& env,  Predicate pred, int i) const;
...
class PGModule  : public PGate {
	...
	// method to pass the range to the pform.
      ...
      virtual void elaborate_scope(Design*des, NetScope*sc) const;
      virtual bool elaborate_sig(Design*des, NetScope*scope) const;
      int typecheck(ostream&out, ostream&PortscheckOut,TypeEnv& env,  map<perm_string,Module*>& modules,int i);
      bool is_checked() const { return checked_; }
      void mark_checked() { checked_ = true; }
